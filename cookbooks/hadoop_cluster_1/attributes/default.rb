...
#
default[:hadoop][:namenode   ][:data_dirs]       = '/hadoop/hdfs/name'
default[:hadoop][:secondarynn][:data_dirs]       = '/hadoop/hdfs/secondary'
...
default[:hadoop][:datanode   ][:data_dirs]       = '/hadoop/hdfs/data'
default[:hadoop][:tasktracker][:scratch_dirs]    = '/hadoop/mapred/system'
...
default[:hadoop][:log_dir]  = "/home/ubuntu/hadoop/log"          # nil set in recipe using volume_dirs
